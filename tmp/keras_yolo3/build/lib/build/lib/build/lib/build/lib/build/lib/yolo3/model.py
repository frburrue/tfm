...
def yolo_loss(args, anchors, num_classes, ignore_thresh=0.5, print_loss=False):
    ...
    for l in range(num_layers):
        ...
        import pickle
        with open("/home/ubuntu/anchors.pckl", 'wb') as fd:
            pickle.dump(anchors, fd)
        with open("/home/ubuntu/anchor_mask.pckl", 'wb') as fd:
            pickle.dump(anchor_mask, fd)
        with open("/home/ubuntu/num_layers.pckl", 'wb') as fd:
            pickle.dump(num_layers, fd)
